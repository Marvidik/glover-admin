          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                {/** Fields for recipient_name, recipient_account_number, recipient_routing_number, etc. */}
                {/* All fields already written in your original code block above */}
                {/* You can paste the whole grid of <FormField /> here as it is */}

                {/* Paste the same fields here again if needed */}
              </div>
